...
object AIR_QUAlITY {
    ...
    fun AIR_QUAlITY.QualityType.desc():String{
        return when(this) {
            ...
            QualityType.max_o3 -> "오존은 강력한 산화력을 가진 기체로, ppm(100만분의 1) 농도가 높을수록 호흡기 및 눈에 심각한 자극과 손상을 줍니다." +
                    "0.1 ppm 이상에서 호흡기 자극과 기침이 시작되며, 0.3~0.5 ppm 이상에서는 운동 중 폐 기능이 눈에 띄게 감소하고 0.5 ppm 이상이면 " +
                    "흉부 불안 등의 증상이 나타나 매우 위험0.01~0.02 ppm: 특유의 냄새를 감지할 수 있는 수준. " +
                    "0.1 ppm (주의보 수준): 1시간 노출 시 코와 목에 자극, 기침, 눈 자극 증상 증가. " +
                    "0.3~0.5 ppm: 2시간 노출 시 운동 중 폐 기능 감소, 호흡 곤란 유발. " +
                    "0.5 ppm 이상 (경보 수준): 6시간 이상 노출 시 마른기침, 흉부 통증, 호흡기 질환 악화. " +
                    "1~2 ppm: 2시간 노출 시 두통, 흉부 통증, 상부 기도 건조 및 기침 발생. 만성 중독 증상. " +
                    "5~10 ppm: 맥박 증가, 통증 유발, 마비 증세 발생 가능."
