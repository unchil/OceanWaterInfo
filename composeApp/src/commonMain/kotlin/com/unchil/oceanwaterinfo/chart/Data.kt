    ...
    fun AIR_QUAlITY.QualityType.desc():String{
        return when(this) {
            QualityType.max_no2 -> "이산화질소(NO2)는 주로 자동차 배기가스나 화력 발전소 등 연소 과정에서 발생하는 적갈색의 독성 기체입니다. " +
                    ...
                    "만성폐쇄성폐질환(COPD): 기도의 가래 배출 능력을 저하시키고 세균 감염에 대한 저항력을 약화시킵니다. 이는 감기나 폐렴 같은 2차 감염으로 이어져 병세가 급격히 악화되는 원인이 됩니다.어린이 및 영유아: 폐가 완전히 발달하지 않은 상태에서 이산화질소에 지속적으로 노출되면 성인이 된 후에도 폐 기능이 정상보다 낮아지는 '폐 성장 저해'가 발생할 수 있습니다."
