...
export const qualityDetails = {
    ...
    'pm25': {   specialFeature: "수도권 초미세먼지의 상당 부분이 2차적 발생으로 대기 중으로 배출된 황산화물(SO_x), 질소산화물(NO_x), 암모니아(NH_3) 등이 화학 반응을 일으켜 미세먼지로 변함.",
                ranges: ["~ 9.0", "~ 35.4", "~ 55.4", "~ 125.4", "~ 225.4", "~ "],
                comments: [
                    "대기 오염으로 인한 건강 위험이 없거나 거의 없는 상태입니다. 모든 인구 집단이 야외 활동을 하기에 안전합니다.",
                    "대기질이 수용 가능한 수준이지만, 일부 오염 물질(특히 오존이나 미세먼지)에 극도로 민감한 극소수의 사람들에게는 가벼운 호흡기 증상이 나타날 수 있습니다.",
                    "일반 대중에게는 큰 영향이 없으나, **민감군(어린이, 노인, 천식 등 호흡기/심장 질환자, 임산부)**은 건강에 직접적인 영향을 받기 시작합니다. 미세먼지/황산화물(또는 이산화황)/질소 가스: 민감군의 기침, 호흡 곤란, 가슴 답답함 유발. 일산화탄소: 협심증 등 심장 질환 환자의 운동 능력 저하 및 가슴 통증 유발.",
                    "건강한 성인도 신체적 증상(눈 따가움, 기침, 두통)을 느끼기 시작하며, 민감군의 경우 심각한 건강 문제가 발생할 수 있습니다. 오존/이산화질소: 기도 점막에 염증이 생겨 깊은 숨을 들이쉴 때 통증을 유발하고 폐 기능이 일시적으로 감소합니다. 암모니아/황화수소 : 자극적인 악취가 강해지며 눈물, 콧물, 메스꺼움을 유발합니다.",
                    "건강 경보가 발령되는 수준입니다. 모든 사람이 장시간 노출 시 심각한 호흡기 및 심혈관 유해 영향을 받을 위험이 매우 높습니다. 미세먼지: 혈관으로 침투해 심장마비, 뇌졸중 위험을 급격히 높이고 천식 환자의 급성 발작을 유발합니다. 일산화탄소: 헤모글로빈 산소 운반 저하로 가벼운 두통, 어지러움, 판단력 저하가 시작됩니다. 황화수소: 후각 신경이 점차 마비되어 오히려 썩은 달걀 냄새를 인지하지 못하게 되므로 매우 위험한 단계입니다.",
                    "비상 사태 수준입니다. 전 인구 집단에게 심각한 건강 손상을 초래하거나 치명적일 수 있습니다. 이산화황/이산화질소: 화학적 자극으로 인해 폐수종(폐에 물이 참)이나 만성 폐쇄성 폐질환(COPD) 환자의 급성 사망 위험이 증가합니다. 일산화탄소: 중추신경계 마비, 구토, 의식 상실을 유발합니다. 암모니아/황화수소: 기도의 화학적 화상, 후두 부종으로 인한 질식, 신경계 마비로 인한 급성 '노크다운(의식 상실)' 및 심정지를 일으킬 수 있는 치명적인 농도입니다."
                ],
                sensitiveInfo: `심혈관계 질환, 뇌졸중, 암(1군 발암물질)의 원인이 되기도 합니다.`
            },


    'pm10': {   specialFeature: "1차적 발생은 공장, 자동차, 건설 현장에서 직접 배출되거나 흙먼지, 꽃가루와 같이 자연적으로 발생",
                ranges: ["~ 54.0", "~ 154.0", "~ 254.0", "~ 354.0", "~ 424.0", "~ "],
                comments: [
                    "대기 오염으로 인한 건강 위험이 없거나 거의 없는 상태입니다. 모든 인구 집단이 야외 활동을 하기에 안전합니다.",
                    "대기질이 수용 가능한 수준이지만, 일부 오염 물질(특히 오존이나 미세먼지)에 극도로 민감한 극소수의 사람들에게는 가벼운 호흡기 증상이 나타날 수 있습니다.",
                    "일반 대중에게는 큰 영향이 없으나, **민감군(어린이, 노인, 천식 등 호흡기/심장 질환자, 임산부)**은 건강에 직접적인 영향을 받기 시작합니다. 미세먼지/황산화물(또는 이산화황)/질소 가스: 민감군의 기침, 호흡 곤란, 가슴 답답함 유발. 일산화탄소: 협심증 등 심장 질환 환자의 운동 능력 저하 및 가슴 통증 유발.",
                ...
                sensitiveInfo: `상기도 염증, 기침, 천식을 유발할 수 있습니다.`
            },


    'no2': {
        specialFeature: "매연 또는 찌릿한 염소(수영장) 냄새",
        ranges: ["~ 0.053", "~ 0.100", "~ 0.360", "~ 0.649", "~ 1.249", "~ "],
        comments: [
                    "대기 오염으로 인한 건강 위험이 없거나 거의 없는 상태입니다. 모든 인구 집단이 야외 활동을 하기에 안전합니다.",
                    "대기질이 수용 가능한 수준이지만, 일부 오염 물질(특히 오존이나 미세먼지)에 극도로 민감한 극소수의 사람들에게는 가벼운 호흡기 증상이 나타날 수 있습니다.",
                    "일반 대중에게는 큰 영향이 없으나, **민감군(어린이, 노인, 천식 등 호흡기/심장 질환자, 임산부)**은 건강에 직접적인 영향을 받기 시작합니다. 미세먼지/황산화물(또는 이산화황)/질소 가스: 민감군의 기침, 호흡 곤란, 가슴 답답함 유발. 일산화탄소: 협심증 등 심장 질환 환자의 운동 능력 저하 및 가슴 통증 유발.",
        ...
        sensitiveInfo: `천식 환자: 기도의 과민성을 높여 평소보다 알레르기 유발 물질에 격렬하게 반응하게 합니다. 0.2~0.3ppm 수준에서도 발작 빈도가 높아질 수 있습니다. 만성폐쇄성폐질환(COPD): 가래 배출 능력을 저하시키고 세균 감염 저항력을 약화시킵니다. 어린이: 지속 노출 시 성인이 된 후에도 폐 기능이 낮아지는 폐 성장 저해가 발생할 수 있습니다.`
    },

    'o3': {
        specialFeature: "복사기/프린터 근처의 비릿한 냄새 또는 소나기 직후의 상쾌한 듯 비릿한 풀내음",
        ranges: ["~ 0.054", "~ 0.070", "~ 0.085", "~ 0.105", "~ 0.200", "~ "],
        comments: [
                    "대기 오염으로 인한 건강 위험이 없거나 거의 없는 상태입니다. 모든 인구 집단이 야외 활동을 하기에 안전합니다.",
                    "대기질이 수용 가능한 수준이지만, 일부 오염 물질(특히 오존이나 미세먼지)에 극도로 민감한 극소수의 사람들에게는 가벼운 호흡기 증상이 나타날 수 있습니다.",
                    "일반 대중에게는 큰 영향이 없으나, **민감군(어린이, 노인, 천식 등 호흡기/심장 질환자, 임산부)**은 건강에 직접적인 영향을 받기 시작합니다. 미세먼지/황산화물(또는 이산화황)/질소 가스: 민감군의 기침, 호흡 곤란, 가슴 답답함 유발. 일산화탄소: 협심증 등 심장 질환 환자의 운동 능력 저하 및 가슴 통증 유발.",
        ...
        sensitiveInfo: `천식 환자: 기도를 수축시키고 염증 반응을 일으킵니다. 0.05ppm 수준에서도 기침과 천명이 심해질 수 있습니다. 만성폐쇄성폐질환(COPD): 폐의 산소 교환 능력이 급격히 떨어져 호흡 곤란을 심화시킵니다. 영구적 손상: 반복 노출 시 폐 조직의 섬유화(딱딱해짐)를 초래할 수 있습니다.`
    },

    'co': {
        specialFeature: "무색, 무취, 무미의 특성",
        ranges: ["~ 4.4", "~ 9.4", "~ 12.4", "~ 15.4", "~ 30.4", "~ "],
        comments: [
                    "대기 오염으로 인한 건강 위험이 없거나 거의 없는 상태입니다. 모든 인구 집단이 야외 활동을 하기에 안전합니다.",
                    "대기질이 수용 가능한 수준이지만, 일부 오염 물질(특히 오존이나 미세먼지)에 극도로 민감한 극소수의 사람들에게는 가벼운 호흡기 증상이 나타날 수 있습니다.",
                    "일반 대중에게는 큰 영향이 없으나, **민감군(어린이, 노인, 천식 등 호흡기/심장 질환자, 임산부)**은 건강에 직접적인 영향을 받기 시작합니다. 미세먼지/황산화물(또는 이산화황)/질소 가스: 민감군의 기침, 호흡 곤란, 가슴 답답함 유발. 일산화탄소: 협심증 등 심장 질환 환자의 운동 능력 저하 및 가슴 통증 유발.",
        ...
        sensitiveInfo: `산소 부족 가속화: COPD나 폐기종 환자는 혈중 산소 포화도가 낮아 CO 유입 시 급성 호흡 부전이 올 수 있습니다. 심장 과부하: 산소 부족 보상을 위해 심장이 과하게 뛰어 심근경색이나 부정맥 위험이 높아집니다. 낮은 농도 민감성: 일반인은 무증상인 50ppm에서도 폐질환자는 가슴 통증이나 호흡 곤란을 겪을 수 있습니다.`
    },

    'so2': {
        specialFeature: "금방 끈 성냥의 탄내 또는 화약 냄새",
        ranges: ["~ 0.035", "~ 0.075", "~ 0.185", "~ 0.304", "~ 0.604", "~ "],
        comments: [
                    "대기 오염으로 인한 건강 위험이 없거나 거의 없는 상태입니다. 모든 인구 집단이 야외 활동을 하기에 안전합니다.",
                    "대기질이 수용 가능한 수준이지만, 일부 오염 물질(특히 오존이나 미세먼지)에 극도로 민감한 극소수의 사람들에게는 가벼운 호흡기 증상이 나타날 수 있습니다.",
                    "일반 대중에게는 큰 영향이 없으나, **민감군(어린이, 노인, 천식 등 호흡기/심장 질환자, 임산부)**은 건강에 직접적인 영향을 받기 시작합니다. 미세먼지/황산화물(또는 이산화황)/질소 가스: 민감군의 기침, 호흡 곤란, 가슴 답답함 유발. 일산화탄소: 협심증 등 심장 질환 환자의 운동 능력 저하 및 가슴 통증 유발.",
        ...
        sensitiveInfo: `기도 수축: 이산화황은 기도 근육을 수축시킵니다. 천식 환자는 일반인보다 훨씬 민감하며 단 5-10분 노출로도 심한 호흡 곤란을 겪을 수 있습니다. 만성기관지염: 가래 분비를 비정상적으로 늘려 기도를 폐쇄하고 심부전 위험을 높입니다.`
    },

    'nh3': {
        specialFeature: "오래 방치된 공중화장실 또는 삭힌 홍어 냄새",
        ranges: ["~ 0.25", "~ 0.70", "~ 1.50", "~ 5.00", "~ 25.00", "~ "],
        comments: [
                    "대기 오염으로 인한 건강 위험이 없거나 거의 없는 상태입니다. 모든 인구 집단이 야외 활동을 하기에 안전합니다.",
                    "대기질이 수용 가능한 수준이지만, 일부 오염 물질(특히 오존이나 미세먼지)에 극도로 민감한 극소수의 사람들에게는 가벼운 호흡기 증상이 나타날 수 있습니다.",
                    "일반 대중에게는 큰 영향이 없으나, **민감군(어린이, 노인, 천식 등 호흡기/심장 질환자, 임산부)**은 건강에 직접적인 영향을 받기 시작합니다. 미세먼지/황산화물(또는 이산화황)/질소 가스: 민감군의 기침, 호흡 곤란, 가슴 답답함 유발. 일산화탄소: 협심증 등 심장 질환 환자의 운동 능력 저하 및 가슴 통증 유발.",
        ...
        sensitiveInfo: `화학적 폐렴 위험: 암모니아가 폐포 상피 세포를 파괴하여 유발합니다. 급성 기도 폐쇄: 천식/COPD 환자는 암모니아 자극에 기도가 급격히 부어올라 공기 통로가 차단될 수 있습니다. 이차 감염: 점막과 섬모 손상으로 외부 세균 방어막이 사라져 2차 세균성 폐렴 위험이 높아집니다.`
    },

    'h2s': {
        specialFeature: "상한 달걀 냄새로 저농도에서는 감지되나 농도가 높아지면 후각 신경을 마비시켜 위험함",
        ranges: ["~ 0.01", "~ 0.05", "~ 0.10", "~ 1.00", "~ 10.00", "~ "],
        comments: [
                    "대기 오염으로 인한 건강 위험이 없거나 거의 없는 상태입니다. 모든 인구 집단이 야외 활동을 하기에 안전합니다.",
                    "대기질이 수용 가능한 수준이지만, 일부 오염 물질(특히 오존이나 미세먼지)에 극도로 민감한 극소수의 사람들에게는 가벼운 호흡기 증상이 나타날 수 있습니다.",
                    "일반 대중에게는 큰 영향이 없으나, **민감군(어린이, 노인, 천식 등 호흡기/심장 질환자, 임산부)**은 건강에 직접적인 영향을 받기 시작합니다. 미세먼지/황산화물(또는 이산화황)/질소 가스: 민감군의 기침, 호흡 곤란, 가슴 답답함 유발. 일산화탄소: 협심증 등 심장 질환 환자의 운동 능력 저하 및 가슴 통증 유발.",
        ...
        sensitiveInfo: `급성 폐수종: 폐혈관 투과성을 높여 폐에 물이 차게 만듭니다. 산소 부족 상태의 COPD 환자에게 치명적입니다. 기도 과민성 증폭: 매우 낮은 농도(2-5ppm)에서도 기도가 경련을 일으킬 수 있습니다. 조직 재생 저해: 미토콘드리아 기능을 억제하여 폐 기능 회복을 불가능하게 할 수 있습니다.`
    },
...
const qualityDescriptions = {
    ...
    'no2':`이산화질소(NO2)는 주로 자동차 배기가스나 화력 발전소 등 연소 과정에서 발생하는 적갈색의 독성 기체입니다.  오존과 마찬가지로 물에 잘 녹지 않아 폐 깊숙한 곳까지 침투하며, 농도에 따라 다음과 같은 영향을 미칩니다.
    ...
    'o3':  `오존(O3)은 강력한 산화력을 가진 기체로, 농도에 따라 호흡기 및 심혈관 계통에 상당한 자극을 줍니다.  특히 폐 기능이 이미 저하된 환자들에게는 낮은 농도에서도 치명적일 수 있습니다.
    ...
    'co': `일산화탄소(CO)는 '소리 없는 살인자'라고 불릴 만큼 무색, 무취, 무미의 특성을 가집니다. 폐를 통해 혈액으로 들어간 CO는 산소를 운반하는 헤모글로빈(Hb)과 결합하여 **일산화탄소-헤모글로빈(COHb)**을 형성하는데, 그 결합력이 산소보다 약 200~250배 강해 체내 산소 공급을 차단합니다.
    ...
    'so2': `이산화황(SO2)은 물에 매우 잘 녹는 수용성 기체로, 흡입 시 상기도(코, 목)의 점막에 즉각적으로 흡수되어 황산을 형성하며 강한 자극을 일으킵니다. 특히 대기 중 미세먼지와 결합하여 폐 깊숙이 침투할 경우 그 피해가 더 커집니다.
    ...
    'nh3': `암모니아(NH3)는 강한 알칼리성을 띠는 부식성 가스로, 물에 매우 잘 녹는 성질이 있습니다. 흡입 시 호흡기 점막의 수분과 결합하여 강염기인 수산화암모늄(NH4OH)을 형성하며 조직을 녹여내는 화학적 화상을 입힙니다.
    ...
    'h2s': `황화수소(H2S)는 달걀 썩는 냄새가 나는 무색의 독성 기체로, 화산 가스나 하수구, 폐수 처리장 등 유기물이 부패하는 곳에서 주로 발생합니다. 이 기체는 세포의 호흡 기전(세포 내 산소 이용)을 마비시키기 때문에 '화학적 질식제'로 분류됩니다. 저농도에서는 냄새로 감지되지만, 농도가 높아지면 후각 신경을 마비시켜 냄새를 맡지 못하게 하므로 매우 기만적이고 위험합니다.
    ...
    'pm10': `PM10 (미세먼지): 입자의 지름이 10 마이크로미터 이하인 먼지입니다. 사람의 머리카락 굵기(약 50 ~ 70 마이크로미터)보다 5~7배 정도 작습니다. 코털이나 기관지 점막에서 어느 정도 걸러지지만, 과다 노출 시 상기도 염증, 기침, 천식을 유발할 수 있습니다.
    ...
    'pm25': `PM2.5 (초미세먼지): 입자의 지름이 2.5 마이크로미터 이하인 먼지입니다. 머리카락 굵기보다 20~30배 정도 작아 눈에 보이지 않을 정도로 매우 미세합니다. 크기가 너무 작아 폐포(허파꽈리)까지 직접 도달하며, 혈관을 타고 전신으로 퍼질 수 있습니다. 이는 심혈관계 질환, 뇌졸중, 암(1군 발암물질)의 원인이 되기도 합니다.
